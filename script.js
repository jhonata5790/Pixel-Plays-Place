const jogos = [
  ...
  // =========================================
  {
    ...
    descricao:
      "Um jogo de plataforma 2D em Scratch com sete cenários, wall jump, coleta de pixels, chave e porta, obstáculos e uma batalha final contra Burn.",
  ...
  // =========================================
  {
    ...
    pagina:
      "jogos/infantus.html?v=5",

    capa:
      "assets/capas/infantus.png?v=5",
